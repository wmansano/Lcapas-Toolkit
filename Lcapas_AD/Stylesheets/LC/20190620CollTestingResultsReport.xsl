        ...
        <div class="main">
          <div class="container">
            <table class="table1" cellpadding="0" cellspacing="0" border="0">
              <tr>
                <td>
                  <p class="heading0">Testing Results Reports</p> 
                </td>
              </tr>
              <tr><td style="height: 20px;"></td></tr>

                  <!-- TestingResultsReports-->
                ...
                <td>
                  <table class="table2" cellspacing="0" cellpadding="2">
                    <tr class="heading1">
						...
						<td class="labelBold cell" style="width: 150px;">Last Name</td>
						<td class="labelBold cell" style="width: 150px;">First Name</td>
						<td class="labelBold cell" style="width: 150px;">Middle Name</td>
						<td class="labelBold cell" style="width: 150px;">Status Date</td>
                    </tr>
					  <xsl:for-each select="TestingResultsReports/CollTestingResultsReportSearchResultsFilter">
							  <tr class="cell">
								  ...
								  <td  style="width: 150px;">
								    ...
								    <td style="width: 150px;">
									  <xsl:call-template name="formatdate">
										  <xsl:with-param name="DateTimeStr" select="STATUS_DATE"/>
									  </xsl:call-template>
								  </td>
