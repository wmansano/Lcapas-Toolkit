        ...
        <div class="main">
          <div class="container">
            <table class="table1" cellpadding="0" cellspacing="0" border="0">
              <tr>
                <td>
                  <p class="heading0">Wait List Reports</p> 
                </td>
              </tr>
              ...
              <tr>
                <td>
                  <table class="table2" cellspacing="0" cellpadding="2">
                    <tr class="heading1">
						<td class="labelBold cell" style="width: 150px;">Person ID</td>
						<td class="labelBold cell" style="width: 150px;">LName, FName, MName</td>
						<td class="labelBold cell" style="width: 150px;">Term</td>
						<td class="labelBold cell" style="width: 150px;">Appl Status Date</td>
						<td class="labelBold cell" style="width: 150px;">Appl Status Time</td>
						<td class="labelBold cell" style="width: 150px;">Citizenship Country</td>
						<td class="labelBold cell" style="width: 150px;">Visa Status</td>
						<td class="labelBold cell" style="width: 150px;">Program</td>
						<td class="labelBold cell" style="width: 150px;">Residence Country</td>

                    </tr>
					
					  <xsl:for-each select="WaitListReports/CollWaitListReportSearchResultsFilter">
							  <tr class="cell">	
								  <td  style="width: 150px;">
									  <xsl:value-of select="APPL_APPLICANT"/>
								  </td>
								   <td  style="width: 150px;">
									  <xsl:value-of select="FullName"/>
								  </td>
								  <td  style="width: 150px;">
									  <xsl:value-of select="APPL_START_TERM"/>
								  </td>
				

								  <td style="width: 150px;">
									  <xsl:call-template name="formatDateOnly">
										  <xsl:with-param name="DateTimeStr" select="APPL_STATUS_DATE"/>
									  </xsl:call-template>
								  </td>

								  <td  style="width: 150px;">
									  <xsl:call-template name="formatTimeOnly">
										  <xsl:with-param name="DateTimeStr" select="APPL_STATUS_TIME"/>
									  </xsl:call-template>
								  </td>
								   <td  style="width: 150px;">
									  <xsl:value-of select="APPL_CITIZENSHIP"/>
								  </td>
								  <td  style="width: 150px;">
									  <xsl:value-of select="APPL_VISA_STATUS"/>
								  </td>
								  <td  style="width: 150px;">
									  <xsl:value-of select="APPL_ACAD_PROGRAM"/>
								  </td>
								   <td  style="width: 150px;">
									  <xsl:value-of select="APPL_RESIDENCE"/>
								  </td>
							  </tr>
					  </xsl:for-each>
