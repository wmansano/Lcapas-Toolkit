                ...
                <td>
                  <table class="table2" cellspacing="0" cellpadding="2">
                    <tr class="heading1">
                        ...
                        <td class="labelBold cell" style="min-width: 70px;">Department</td>
						<td class="labelBold cell" style="min-width: 40px;">Term</td>
                    </tr>
					<xsl:for-each select="UnsolicitedBatchTranscriptReports/UnsolicitedBatchObj">
						<tr class="cell">
                            <td>
						    ...
						    <td>
							    <xsl:value-of select="ProgramCode"/> - <xsl:value-of select="ProgramTitle"/>
						    </td>
                            <td>
                                <xsl:value-of select="DeptCode"/> - <xsl:value-of select="DeptTitle"/>
                            </td>
						    <td>
