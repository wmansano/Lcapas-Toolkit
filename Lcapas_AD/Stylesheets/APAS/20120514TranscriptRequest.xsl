...
<xsl:stylesheet version="1.0" xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:tr="urn:org:pesc:message:TranscriptRequest:v1.4.0"  exclude-result-prefixes="tr">
    ...
    <html>
      <head>
        ...
        <style type="text/css">
          ...
          .containerLC { margin-left: auto; margin-right: auto; width: 800px; text-align: left; }
          ...
          .tableMainLC .heading0LC { font: normal 20px Arial;  background: none; border: 0px; border-bottom: 1px solid #999966; color: #78A22F; }
          .tableMainLC td.heading1LC { font: normal 14px Verdana; background: none; border: 0px; border-bottom: 1px solid #bbbb88; color: #78A22F; }
      ...
      <body>
        <div class="mainLC">
          <div class="containerLC">
            <xsl:for-each select=".//tr:TranscriptRequest">

              <table class="tableMainLC page-breakLC" cellpadding="0" cellspacing="0" border="0">
              <tr>
                <td>
                  <p class="heading0LC">Transcript Request</p> 
                  <xsl:if test="tr:TransmissionData/DocumentProcessCode = 'TEST'">
                    <div class="labelRedLC" align="center"><xsl:value-of select="tr:TransmissionData/DocumentProcessCode"/></div>
                  </xsl:if>
                </td>
              </tr>
                ...
                <td>
                  <table class="tableSecondLC" cellspacing="0" cellpadding="2">
                    <tr>
                      ...
                      <td class="labelLC" style="width: 180px;"><xsl:value-of select="tr:Request/RequestedStudent/Person/AgencyIdentifier/AgencyAssignedID"/></td>
                      <td class="labelBoldLC" style="width: 145px;">Recipient Assigned ID:</td>
                      <td class="labelLC" style="width: 200px;"><xsl:value-of select="tr:Request/RequestedStudent/Person/RecipientAssignedID"/></td>
                    </tr>
                    <tr>
                      <td class="labelBoldLC">School Assigned ID:</td>
                      <td class="labelLC"><xsl:value-of select="tr:Request/RequestedStudent/Person/SchoolAssignedPersonID"/></td>
                      <td class="labelBoldLC">Last High School:</td>
                      <td class="labelLC"><xsl:value-of select="tr:Request/RequestedStudent/Person/HighSchool/OrganizationName"/></td>
                    </tr>
                    <tr>
                      <td class="labelBoldLC">Gender:</td>
                      <td class="labelLC"><xsl:value-of select="tr:Request/RequestedStudent/Person/Gender/GenderCode"/></td>
                      <td class="labelBoldLC">Birthdate:</td>
                      <td class="labelLC"><xsl:value-of select="tr:Request/RequestedStudent/Person/Birth/BirthDate"/></td>
                    </tr>
                    <tr>
                      <td class="labelBoldLC">First Name:</td>
                      <td class="labelLC"><xsl:value-of select="tr:Request/RequestedStudent/Person/Name/FirstName"/></td>
                      <td class="labelBoldLC">Last Name:</td>
                      <td class="labelLC"><xsl:value-of select="tr:Request/RequestedStudent/Person/Name/LastName"/></td>
                    </tr>
                    <xsl:if test="tr:Request/RequestedStudent/Person/Name/MiddleName">
                      <tr>
                        <td class="labelBoldLC">Middle Name(s):</td>
                        <td class="labelLC">
                          <xsl:for-each select="tr:Request/RequestedStudent/Person/Name/MiddleName">
                    ...
                    <!-- Alternate Names -->
                    <xsl:if test="tr:Request/RequestedStudent/Person/AlternateName">
                      <tr><td colspan="4" style="height: 15px;"></td></tr>
                      <tr><td colspan="4" class="heading2LC">Former Names</td></tr>
                      <xsl:for-each select="tr:Request/RequestedStudent/Person/AlternateName">
                        <tr>
                          <td class="labelBoldLC">First Name:</td>
                    ...
                    <!-- Contacts -->
                    <xsl:if test="tr:Request/RequestedStudent/Person/Contacts/Address">
                      <tr><td colspan="4" style="height: 15px;"></td></tr>
                      <xsl:for-each select="tr:Request/RequestedStudent/Person/Contacts/Address">
                        <tr>
                    ...
                    <!-- Phones -->
                    <xsl:if test="tr:Request/RequestedStudent/Person/Contacts/Phone">
                      <tr><td colspan="4" style="height: 15px;"></td></tr>
                      <xsl:for-each select="tr:Request/RequestedStudent/Person/Contacts/Phone">
                        <tr>
                    ...
                    <!-- Emails -->
                    <xsl:if test="tr:Request/RequestedStudent/Person/Contacts/Email">
                      <tr><td colspan="4" style="height: 15px;"></td></tr>
                      <xsl:for-each select="tr:Request/RequestedStudent/Person/Contacts/Email">
                        <tr>
                ...
                <td>
                  <table class="tableSecondLC" cellspacing="0" cellpadding="2">
                    <tr>
                      ...
                      <td class="labelLC" style="width: 180px;"><xsl:value-of select="tr:Request/RequestedStudent/Attendance/School/OrganizationName"/></td>
                      <td class="labelBoldLC" style="width: 145px;">Current Enrollment:</td>
                      <td class="labelLC" style="width: 200px;"><xsl:value-of select="tr:Request/RequestedStudent/Attendance/CurrentEnrollmentIndicator"/></td>
                    </tr>
                    <tr>
                      <td class="labelBoldLC">Enrollment Date:</td>
                      <td class="labelLC"><xsl:value-of select="tr:Request/RequestedStudent/Attendance/EnrollDate"/></td>
                      <td class="labelBoldLC">Exit Date:</td>
                      <td class="labelLC"><xsl:value-of select="tr:Request/RequestedStudent/Attendance/ExitDate"/></td>
                    </tr>
                    
                    <!-- Academic Awards -->
                    <xsl:if test="tr:Request/RequestedStudent/Attendance/AcademicAwardsReported">
                      <tr><td colspan="4" style="height: 15px;"></td></tr>
                      <xsl:for-each select="tr:Request/RequestedStudent/Attendance/AcademicAwardsReported">
                        <tr>
                ...
                <td>
                  <table class="tableSecondLC" cellspacing="0" cellpadding="2">
                    <tr>
                      ...
                      <td class="labelLC" style="width: 180px;"><xsl:value-of select="tr:Request/RequestedStudent/ReleaseAuthorizedIndicator"/></td>
                      <td class="labelBoldLC" style="width: 145px;">Method:</td>
                      <td class="labelLC" style="width: 200px;"><xsl:value-of select="tr:Request/RequestedStudent/ReleaseAuthorizedMethod"/></td>
                    </tr>
                  </table>
                </td>
              </tr>
              ...
              <!-- Transcript Purpose -->
              <tr><td class="heading1LC">Transcript Purpose</td></tr>
              <tr>
                <td>
                  <table class="tableSecondLC" cellspacing="0" cellpadding="2">
                    <tr>
                      <td class="labelBoldLC" style="width: 125px;">Transcript Purpose:</td>
                      <td class="labelLC" style="width: 180px;"><xsl:value-of select="tr:Request/Recipient/TranscriptPurpose"/></td>
                      <td class="labelBoldLC" style="width: 145px;"> </td>
              ...
              <!-- Hold -->
              <tr><td class="heading1LC">Hold</td></tr>
              <tr>
                <td>
                  <table class="tableSecondLC" cellspacing="0" cellpadding="2">
                    <tr>
                      <td class="labelBoldLC" style="width: 125px;">Hold Type:</td>
                      <td class="labelLC" style="width: 180px;"><xsl:value-of select="tr:Request/Recipient/TranscriptHold/HoldType"/></td>
                      <xsl:if test="tr:Request/Recipient/TranscriptHold/HoldType = 'Now'">
                        <td class="labelBoldLC" style="width: 145px;"> </td>
                        <td class="labelLC" style="width: 200px;"> </td>
                      </xsl:if>
                      <xsl:if test="tr:Request/Recipient/TranscriptHold/HoldType = 'AfterDegreeAwarded'">
                        <td class="labelBoldLC" style="width: 145px;"> </td>
                        <td class="labelLC" style="width: 200px;"> </td>
                      </xsl:if>
                      <xsl:if test="tr:Request/Recipient/TranscriptHold/HoldType = 'AfterGradesPosted'">
                        <td class="labelBoldLC" style="width: 145px;">Session Designator:</td>
                        <td class="labelLC" style="width: 200px;">
                          <xsl:value-of select="tr:Request/Recipient/TranscriptHold/SessionDesignator"/>
                        </td>
                      </xsl:if>
                      <xsl:if test="tr:Request/Recipient/TranscriptHold/HoldType = 'AfterSpecifiedTerm'">
                        <td class="labelBoldLC" style="width: 145px;">SessionDesignator:</td>
                        <td class="labelLC" style="width: 200px;">
                          <xsl:value-of select="tr:Request/Recipient/TranscriptHold/SessionDesignator"/>
                        </td>
                      </xsl:if>
                      <xsl:if test="tr:Request/Recipient/TranscriptHold/HoldType = 'AfterSpecifiedCourseGrade'">
                        <td class="labelBoldLC" style="width: 145px;">Course Title:</td>
                        <td class="labelLC" style="width: 200px;">
                          <xsl:value-of select="tr:Request/Recipient/TranscriptHold/CourseTitle"/>
                        </td>
                      </xsl:if>
                      <xsl:if test="tr:Request/Recipient/TranscriptHold/HoldType = 'AfterSpecifiedDate'">
                        <td class="labelBoldLC" style="width: 145px;">Release Date:</td>
                        <td class="labelLC" style="width: 200px;">
                          <xsl:value-of select="tr:Request/Recipient/TranscriptHold/ReleaseDate"/>
                        </td>
                      </xsl:if>
                    </tr>
                  </table>
                ...
                <td>
                  <table class="tableSecondLC" cellspacing="0" cellpadding="2">
                    <tr>
                      ...
                      <td class="labelLC" style="width: 180px;"><xsl:value-of select="tr:TransmissionData/DocumentTypeCode"/></td>
                      <td class="labelBoldLC" style="width: 145px;">Document ID:</td>
                    ...
                    <tr>
                      ...
                      <td class="labelLC"><xsl:value-of select="tr:Request/Recipient/RequestTrackingID"/></td>
                    </tr>
                    <tr>
                      ...
                      <td colspan="4">
                        <table cellspacing="0" cellpadding="2" width="100%">
                          <tr>
                            ...
                            <td class="heading2LC" style="width: 180px;">Requesting</td>
                            <td class="heading2LC" style="width: 340px;" colspan="2">Fulfilling</td>
                          </tr>
                          <tr>
                          ...
                          <tr>
                            ...
                            <td class="labelLC" colspan="2"><xsl:value-of select="tr:TransmissionData/Destination/Organization/LocalOrganizationID/LocalOrganizationIDCode"/></td>
                          </tr>
                          <tr>
                            ...
                            <td class="labelLC" colspan="2"><xsl:value-of select="tr:TransmissionData/Destination/Organization/LocalOrganizationID/LocalOrganizationIDQualifier"/></td>
                          </tr>
                          <tr>
                            ...
                            <td class="labelLC" colspan="2"><xsl:value-of select="tr:TransmissionData/Destination/Organization/OrganizationName"/></td>
                          </tr>
                          <tr>
                            ...
                            <td class="labelLC" colspan="2"><xsl:value-of select="tr:TransmissionData/Destination/Organization/Contacts/Phone/PhoneNumber"/></td>
                          </tr>
                          <tr>
                            ...
                            <td class="labelLC" colspan="2"><xsl:value-of select="tr:TransmissionData/Destination/Organization/Contacts/Email/EmailAddress"/></td>
                          </tr>
                        </table>
                      </td>
                    </tr>
