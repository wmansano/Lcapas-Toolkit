...
<xsl:stylesheet version="1.0" xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:HST="urn:org:pesc:message:HighSchoolTranscript:v1.5.0" exclude-result-prefixes="HST">
  ...
  <xsl:template match="/">
    <html>
      <head>
        <title>Transcript (High School)</title>
        <style type="text/css">
          ...
          .cellLC { font: 12px Arial; border: 0px; border-bottom: 1px solid #ebebeb; }

          .tableMainLC .heading0LC { font: bold 20px Arial; background: none; border: 0px; border-bottom: 1px solid #999966; padding: 5px; }
          ...
          .tableSecondLC td.heading3LC { font: bold 12px Verdana; background: #ffffff; border: 0px; border-bottom: 1px solid #bbbbbb; color:#444444;}
      ...
      <body>
        <div class="mainLC">
          <div class="containerLC">
            <xsl:for-each select=".//HST:HighSchoolTranscript">

              <table class="tableMainLC page-breakLC" cellpadding="0" cellspacing="0" border="0">
              <tr>
                <td>
                  <p class="heading0LC">Transcript (High School)</p>
                      ...
                      <td colspan="4">
                        <table border="0" cellspacing="0" cellpadding="2" width="650">
                          ...
                          <tr>
                            ...
                            <td class="labelLC"><xsl:value-of select="TransmissionData/Source/Organization/Contacts/Phone/PhoneNumber"/></td>
                            <td class="labelLC"><xsl:value-of select="TransmissionData/Destination/Organization/Contacts/Phone/PhoneNumber"/></td>
                          </tr>
                          <tr>
